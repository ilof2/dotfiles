...
# Set some variables
wall_dir="${HOME}/Pictures/walls/static/"
cacheDir="${HOME}/.cache/ilof/${theme}"
...
matugen image ${wall_dir}${wall_selection} -t scheme-neutral --contrast -0.2 --source-color-index 0
